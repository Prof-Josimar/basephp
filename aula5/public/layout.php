                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/medico-create.php">Cadastrar</a></li>
                            <li><a class="dropdown-item" href="/medico-list.php">Listar</a></li>
                            <li><a class="dropdown-item" href="/medico-pesquisar.php">Pesquisar</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
